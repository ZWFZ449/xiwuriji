...
namespace CodeStage.AntiCheat.Detectors
{
	...
	public class SpeedHackDetector : ACTkDetectorBase<SpeedHackDetector>
	{
		...
		public void TriggerDetection()
		{
			...
			var detectionInfo = new SpeedHackDetectionInfo(false, false, false, false);
...
#endif
					var detectionInfo = new SpeedHackDetectionInfo(cheatedEnvironment, cheatedRealtime, cheatedDsp, cheatedTimeScale);
					OnCheatingDetected(detectionInfo);
				}
				else
				{
