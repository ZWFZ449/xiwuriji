...
public class PanelMian : PanelBase
{
    ...
    {
        hero_name.text = (SumSave.crtHero.zs_lvs > 1 ? "[" + (SumSave.crtHero.zs_lvs - 1) + "转]" : "") + SumSave.crtMaxBattle.crt_name + " " + Battle_Tool.Obtain_Talent_Name() + " Lv." + SumSave.crtMaxBattle.lv;
