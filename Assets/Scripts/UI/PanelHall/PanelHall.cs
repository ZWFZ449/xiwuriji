...
public class PanelHall : PanelBase
{ 
    /// <summary>
    /// 资源，提升，地图父物体
    /// </summary>
    ...
    public override void Initialize()
    {
        ...
        btn_item_Prefabs = Tool_UI.Find_Prefabs<btn_item>("btn_item"); 
    ...
    private void Show_GameObject(string index, bool active)
    {
        ...
        {
            GameObject obj = Resources.Load<GameObject>("UI/Prefabs/panel_hall/" + index);
