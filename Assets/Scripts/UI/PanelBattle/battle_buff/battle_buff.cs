...
public class battle_buff : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        for (int i = 0; i < buffs.Count; i++)
        {
            ...
            int time = buffs[i].Item3 - spanSeconds;//Ê£ÓàÊ±¼ä
            if (buffs[i].Item1 == common_Buff.ÔÂ¿¨.ToString())
            {
